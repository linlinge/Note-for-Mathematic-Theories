...
\title{Summary for Numerical Analysis}
\author{Linlin Ge}
\date{}
...
\section{Solving for Nonlinear Equation Root $f(x)=0$}
...
\begin{itemize}
\item{Large amount of computation, such as $f(x), f^{'}(x)$}
\item{Sensitive to initial value}
\end{itemize}
\paragraph{Iterative formula:}
